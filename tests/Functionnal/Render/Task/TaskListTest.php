...
class TaskListTest extends BaseLayout
{
    /**
    ...
    public function testListRenderWithAdmin(){
        ...
        // We know User own 2 Task and should be able to edit Anon ones
        // => attempt 4 delete button
        $this->checkDeleteForm(4, $crawler);
    }
